function [ Binary_matrix,path] = Constraint_Dijkstra1( D,edge_matrix,weights,sn,ang)
...
%        On exit: 
%        path                  path
%        Binary_matrix         each row represent points connected to a
%        given landmark
%  Amir Babaeian.
